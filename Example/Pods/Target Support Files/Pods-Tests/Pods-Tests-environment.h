...
#define COCOAPODS_POD_AVAILABLE_LMCircularScrollingFlowLayout
#define COCOAPODS_VERSION_MAJOR_LMCircularScrollingFlowLayout 0
#define COCOAPODS_VERSION_MINOR_LMCircularScrollingFlowLayout 1
#define COCOAPODS_VERSION_PATCH_LMCircularScrollingFlowLayout 0
